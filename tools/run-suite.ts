...
export const EXPECTATIONS = {
   ...
   * above it. Re-derived the same way at WP A2 (`709 + 84 = 793`) WP A3 (`725 + 84 = 809`), WP A4 (`748 + 84 = 832`), audit cycle 1 (`809 + 84 = 893`) and Builder Phase 1 WP B1 (`836 + 84 = 920`).
   *
   ...
   *  at Builder Phase 1 WP B1: 836 tests, 7 skipped. */
  sourceOnlyTestFloor: 836,
  /**
